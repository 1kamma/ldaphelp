...
func main() {
	...
	mux.HandleFunc("/api/schema_replicas", app.handleApiSchemaReplicasList)
	mux.HandleFunc("/api/schema_replica", app.handleApiReplicaSchemaManagerList)
	mux.HandleFunc("/api/schema_replica_modify", app.handleApiReplicaSchemaManagerModify)
	...
	mux.HandleFunc(publicAPIPrefix+"/schema_replicas", app.handleApiSchemaReplicasList)
	mux.HandleFunc(publicAPIPrefix+"/schema_replica", app.handleApiReplicaSchemaManagerList)
	mux.HandleFunc(publicAPIPrefix+"/schema_replica_modify", app.handleApiReplicaSchemaManagerModify)
